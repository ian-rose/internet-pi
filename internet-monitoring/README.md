...
Follow the directions inside the main README file in this repository (make sure you have `services.monitoring.enable: true` in your `config.yml` before running the Ansible playbook).
